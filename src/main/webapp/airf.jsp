    ...
    <div class="container">
      <div class="row">
            ...
            <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
              ...
              <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                  <img src="air5.1.jpg" class="w-100 d-block" alt="First slide">
                </div>
                <div class="carousel-item">
                  <img src="air5.2.jpeg" class="w-100 d-block" alt="Second slide">
                </div>
                <div class="carousel-item">
                  <img src="air5.3.JPG" class="w-100 d-block" alt="Third slide">
                </div>
              </div>
        ...
        <div class="col-md-6 ">
          <div class="shoe-description">
            <p>This Air Jordan 5 Nike stylish shoe is designed for both comfort and performance. It's perfect for any occasion, whether you're going for a formal look or just hanging out.
              <h3>Rs 2500</h3>
            </p>
            ...
            <div class="buy-buttons">
              <a name="" id="" class="btn btn-primary " href="login3.jsp" role="button">Buy Now</a>
      ...
      <div class="row mt-4">
        <div class="col-md-12">
          ...
          <button type="submit" class="bg-primary btn btn-outline-dark" onclick="submitFeedback()">Submit</button>
        </div>
      </div>
