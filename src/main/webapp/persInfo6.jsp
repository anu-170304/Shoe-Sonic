	...
	<main>
		<div class="container-fluid ">
			<div class="container">
				...
				<form action="CustomerInfoController6" method="post">
        ...
        <input type="text" id="price" name="price" value="RS 8000" readonly> 
						
						</br><label for="shoeName">Shoe Name:</label></br>
    <input type="text"  id="shoeName" name="shoeName" value=" Air Force Travis Scott " readonly>
					</div>
					<br>
