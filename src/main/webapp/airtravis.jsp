      ...
      <div class="row">
            ...
            <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
              ...
              <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                  <img src="airtravis1.JPG" class="w-100 d-block" alt="First slide">
                </div>
                <div class="carousel-item">
                  <img src="airtravis1.2.JPG" class="w-100 d-block" alt="Second slide">
                </div>
                <div class="carousel-item">
                  <img src="airtravis1.3.jpg" class="w-100 d-block" alt="Third slide">
                </div>
              </div>
        ...
        <div class="col-md-6 ">
          <div class="shoe-description">
            <p>This Nike Air Force Travis Scott stylish shoe is designed for both comfort and performance. It's perfect for any occasion , formal look or just hanging out.
              <h3>Rs 8000</h3>
            </p>
            ...
            <div class="buy-buttons">
              <a name="" id="" class="btn btn-primary " href="login6.jsp" role="button">Buy Now</a>
