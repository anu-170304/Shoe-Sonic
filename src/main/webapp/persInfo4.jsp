	...
	<main>
		<div class="container-fluid ">
			<div class="container">
				...
				<form action="CustomerInfoController4" method="post">
        ...
        <input type="text" id="price" name="price" value="Rs 1300" readonly> 
						
						</br><label for="shoeName">Shoe Name:</label></br>
    <input type="text"  id="shoeName" name="shoeName" value="ADIDAS" readonly>
					</div>
					<br>
