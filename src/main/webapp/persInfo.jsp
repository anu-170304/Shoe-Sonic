	...
	<main>
		<div class="container-fluid ">
			<div class="container">
				...
				<form action="CustomerInfoController" method="post">
        ...
        <input type="text" id="price" name="price" value="Rs 1000" readonly> 
						
						</br><label for="shoeName">Shoe Name:</label></br>
    <input type="text"  id="shoeName" name="shoeName" value="NIKE" readonly>
					</div>
					<br>
