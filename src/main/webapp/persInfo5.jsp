	...
	<main>
		<div class="container-fluid ">
			<div class="container">
				...
				<form action="CustomerInfoController5" method="post">
        ...
        <input type="text" id="price" name="price" value="RS 850" readonly> 
						
						</br><label for="shoeName">Shoe Name:</label></br>
    <input type="text"  id="shoeName" name="shoeName" value="AIR FORCE 1" readonly>
					</div>
					<br>
