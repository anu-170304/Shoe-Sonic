...
<body>
  ...
  <main>
    <div class="container">
      <div class="row">
            ...
            <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
              ...
              <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                  <img src="adidas1.jpeg" class="w-100 d-block" alt="First slide">
                </div>
                <div class="carousel-item">
                  <img src="adidas2.png" class="w-100 d-block" alt="Second slide">
                </div>
                <div class="carousel-item">
                  <img src="aidas3.jpg" class="w-100 d-block" alt="Third slide">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-6 ">
          <div class="shoe-description">
            <p>This Adidas Black stylish shoe is designed for both comfort and performance. It's perfect for any occasion, whether you're going for a running, playing, formal look, or just hanging out.
              <h3>RS 1300</h3>
            </p>
            ...
            <div class="buy-buttons">
              <a name="" id="" class="btn btn-primary " href="login4.jsp" role="button">Buy Now</a>
            </div>
          </div>
        </div>
      </div>
      <div class="row mt-4">
        <div class="col-md-12">
         <textarea id="feedbackTextarea" class="form-control" rows="4" placeholder="Leave your feedback"></textarea><br>
          <button type="button" class="bg-primary btn btn-outline-dark" onclick="submitFeedback()">Submit</button>
        </div>
      </div>
            ...
            <div class="card-body">
              ...
              <p class="card-text">
                <ul>
                  ...
                  <li style="color: whitesmoke;"><a href="signup.jsp">signup</a></li>
                </ul>
              </p>
            </div>
          </div>
  ...
  <script>
    function submitFeedback() {
      ...
      var feedbackText = document.getElementById("feedbackTextarea").value;
      ...
      // Add the new feedback item to the list
