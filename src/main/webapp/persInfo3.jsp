	...
	<main>
		<div class="container-fluid ">
			<div class="container">
				...
				<form action="CustomerInfoController3" method="post">
        ...
        <input type="text" id="price" name="price" value="RS 2500" readonly> 
						
						</br><label for="shoeName">Shoe Name:</label></br>
    <input type="text"  id="shoeName" name="shoeName" value="AIR JORDAN 5" readonly>
					</div>
					<br>
